...
Снятие чужой новости переводит её в `blocked`. Автор может исправить материал, но только администратор может вернуть его в публичную ленту. При редактировании новости организации или лаборатории администратор может менять список связанных сотрудников в пределах выбранного источника.
